...
import VocabularyDetailCardForNote from './VocabularyDetialCardForNote'
interface Props{
    vocabularys:Vocabulary[]
    editable:boolean,
    noteId:number
}
function VocabularyDetailListForNote({vocabularys, editable, noteId}:Props){
        ...
        <ul >
            {   vocabularys.length?
                vocabularys.map((v) => {
                    return (
                        <li key={v.id}>
                            <VocabularyDetailCardForNote editable={editable} vocabulary={v}/>
                            {
                                (noteId && editable) && 
                                <div>
...
export default VocabularyDetailListForNote